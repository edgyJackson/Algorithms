...
#ifndef _TPF_DETECT_LEAK_H
#define _TPF_DETECT_LEAK_H
...
#ifdef UNICODE
#define MemLeakCheck(varname)	CMemLeakCheck varname(__FILEW__, __LINE__, UNITXT(varname)) ; varname.Reset()
#else
#define MemLeakCheck(varname)	CMemLeakCheck varname(__FILE__, __LINE__, UNITXT(varname)) ; varname.Reset()
#endif
...
#else	
// non debugging mode
#define MemLeakCheck(varname)
#define MemLeakCheckReport(varname)
#define MemLeakCheckMessage(varname)
#endif

#endif // end of _TPF_DETECT_LEAK_H
